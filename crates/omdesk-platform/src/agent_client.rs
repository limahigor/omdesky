...
use omdesk_application::ports::{AgentClient, AgentEndpoint, PortError, PortResult};
...
impl AgentClient for HttpAgentClient {
    ...
    async fn focus_workspace(
        ...
        let _: omdesk_protocol::FocusResponse = self
            .post_json(
                endpoint,
                "/v1/workspaces/focus",
    ...
    async fn sunshine_pair(
        ...
        let _: omdesk_protocol::SunshinePairResponse = self
    ...
    async fn send_command(
        ...
        let _: omdesk_protocol::CommandResponse = self
